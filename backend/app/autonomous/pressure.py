...
LENSES: list[dict] = [
    ...
    },
    {
        ...
        "prompt": (
            ...
            "HUNT THE PIVOT, NOT JUST THE CLONE. The lethal competitor is usually a "
            "funded ADJACENT incumbent who has ALREADY rebranded onto this exact "
            "wedge — a general-pipeline vendor now marketing 'agentic telemetry', "
            "an eval vendor adding cost, a platform giving the feature away. "
            "web_search the obvious adjacent incumbents BY NAME plus this wedge's "
            "keywords, and search '<adjacent category> <new capability> funding "
            "OR launches OR pivot'. A competitor with a marketing site and a design "
            "win leaves no repo or paper — the search is the only way to see it. "
            "If a funded player is ALREADY inline with the buyer and aiming its "
            "marketing at this exact wedge, that is verdict=kills — not weakens. "
            "The reducer/feature being close to free (native platform controls, an "
            "OSS processor) is also a kill, not a caveat.\n"
            "DEMAND IMPLIES OCCUPANCY. If the gap leans on 'demand is proven and "
            "budgeted', treat that as evidence the field is contested and search "
            "harder — proven paid demand with a genuinely empty field is rare and "
