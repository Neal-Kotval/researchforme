...
LENSES: list[dict] = [
    ...
    },
    {
        ...
        "prompt": (
            "INCUMBENT COUNTER-MOVE. Test whether a well-resourced incumbent has "
            "ALREADY closed this gap, or so obviously will that entering is "
            "pointless.\n"
            "THE KILL BAR IS HIGH AND SPECIFIC. verdict=kills ONLY when a named, "
            "funded competitor is ALREADY SHIPPING substantially this same product "
            "to the SAME buyer who can buy it TODAY — the Emerald/Cribl/Langfuse "
            "pattern where the thing exists and is sold. web_search the obvious "
            "adjacent incumbents BY NAME plus the wedge keywords, and "
            "'<adjacent category> <new capability> launches OR pivot' — a "
            "competitor with a marketing site and a design win leaves no repo or "
            "paper, so the search is the only way to see it.\n"
            "DO NOT KILL ON MERE POSSIBILITY. 'A platform COULD bundle this', 'it's "
            "available as free/native controls or OSS', 'a big vendor might fast-"
            "follow' — these are verdict=weakens, NOT kills. Startups routinely "
            "win against a free/native alternative that half-works and against a "
            "feature a giant hasn't prioritized (Datadog beat free Prometheus; "
            "Vanta beat do-it-yourself). Competition is normal; a real "
            "DIFFERENTIATOR against known players is a fundable position, not a "
            "dead one. Reserve kills for 'the identical product is already sold to "
            "this buyer', and use weakens for everything softer — a contested "
            "market with a genuine wedge should survive or weaken, never auto-die.\n"
            "DEMAND IMPLIES CONTESTED, NOT CLOSED. Proven paid demand means the "
            "field has entrants — search harder — but a crowded market with a real "
            "differentiated wedge is where most venture outcomes actually live; "
            "contested is a weaken to justify, not an automatic kill."
        ),
    },
    {
        "key": "demand_mirage",
